          ...
          <DialogDescription>
            ...
            {pendingFormData && (
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                ...
                <p><strong>Título:</strong> {pendingFormData.title}</p>
                <p><strong>Empresa:</strong> {pendingFormData.businessName || "No especificada"}</p>
                <p><strong>Ubicación:</strong> {pendingFormData.location || "No especificada"}</p>
                <p><strong>Modalidad:</strong> {pendingFormData.workModality}</p>
                <p><strong>Programas:</strong> {pendingFormData.coursedProgramIds.length} seleccionados</p>
                <p><strong>Competencias:</strong> {pendingFormData.programCompetencyIds.length} seleccionadas</p>
                <p><strong>Áreas:</strong> {pendingFormData.jobAreaIds.length} seleccionadas</p>
              </div>
            )}
          </DialogDescription>
        </DialogHeader>
