...
// Catalog endpoints
export const CATALOG_IDENTITY_DOCUMENT_TYPE_ENDPOINT = '/identity-document-types';
...
export const CATALOG_INNOVATION_PROCESS_TYPE_ENDPOINT = '/innovation-process-types';
export const CATALOG_ALTERNATIVE_ACADEMIC_ROUTE_ENDPOINT = '/alternative-academic-routes';
